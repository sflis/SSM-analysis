...
def clean_ss_data(data,neighbors,upthreshold,lothreshold):
    ...
    sress,ipixs = get_cluster_evolutionr2(clusters,res,neighbors,upthreshold,lothreshold)
    return sress, ipixs
...
from ssm.fit import fit
from ssm.fit import fitmodules,fitmodulesr
...
rs = optimize.minimize(pfit,[v.val for v in pfit.params],method=method,tol=1.0,options = {'disp' :True})
