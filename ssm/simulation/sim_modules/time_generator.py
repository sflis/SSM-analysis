...
class TimeGenerator(ProcessingModule):
    def __init__(self, start_time, end_time, time_step=datetime.timedelta(seconds=0.1)):
        super().__init__("Time")
    ...
    def configure(self, config):
        ...
        config["n_frames"] = int(
            config["run_duration"].to_datetime().total_seconds()
