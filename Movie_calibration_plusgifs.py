...
for runfile in dumm:
    ...
    zmin_calbat = readout["zmin_caldat_"] - 50
    zmin_calbat = 100
...
#    plt.set_cmap('Greys_r')
    ...
    camera.highlight_pixels([item for sublist in clusters[frame_n] for item in sublist],color='red')
...
#        
    ...
    moviefolder = os.path.join('CALI_4_13312_13638_'+read_from_path[-13:-5])
    if not os.path.isdir(moviefolder):
        os.mkdir('CALI_4_13312_13638_'+read_from_path[-13:-5])
